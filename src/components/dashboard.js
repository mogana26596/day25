        ...
        <div id="content-wrapper" class="d-flex flex-column">
          <div id="content">
                                        ...
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                ...
                                                <div class="col">
                                                     ...
                                                     <div class="progress-bar bg-info"style={{width: 120, height:10, borderRadius:5 }}>
                                                         <ProgressBar now={50} />
                                                          </div>
                                                     </div>
                                            </div>
            ...
            <div class="card-body">
                ...
                <div class="progress-bar bg-danger" style={{borderRadius:10,  marginBottom: 18 }}>
                ...
                <div class="progress-bar bg-warning" style={{borderRadius:10,  marginBottom: 18 }}>
                ...
                <div class="progress-bar" style={{borderRadius:10,  marginBottom: 18 }}>
                ...
                <div class="progress-bar bg-info" style={{borderRadius:10,  marginBottom: 18 }}>
                ...
                <div class="progress-bar bg-success" style={{borderRadius:10,  marginBottom: 18 }}>
                     <ProgressBar now={100} />
                    </div>
                        ...
                        <div class="col-lg-6 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style={{width: 700}}
